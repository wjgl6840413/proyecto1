...
<html>
    ...
    <body>
        ...
        <p>Es un hecho establecido hace demasiado tiempo que un lector se distraerá 
            ...
            web usan el Lorem Ipsum como su texto por defecto, y al hacer una búsqueda
        ...
        <p>Al contrario del pensamiento popular, el texto de Lorem Ipsum no es 
            ...
            durante el Renacimiento. La primera linea del Lorem Ipsum, "Que se alivie
            el dolor mismo..", viene de una linea en la section 1.10.32</p>

        <p>El trozo de texto estándar de Lorem Ipsum utilizado desde el año 1500 se 
            reproduce a continuación para los interesados. Las secciones 1.10.32 y 
            1.10.33 de "de Finibus Bonorum et Malorum" de Cicerón también se 
            reproducen en su forma original exacta, acompañadas de versiones en 
            inglés de la traducción realizada en 1914 por H. Rackham.</p>

        <p>¿Dónde puedo conseguirlo?
            ...
            generadores de Lorem Ipsum que se encuentran en Internet tienden a repetir
            trozos predefinidos cuando sea necesario, haciendo a este el único 
            generador verdadero (válido) en la Internet. Usa un diccionario de mas 
            de 200 palabras provenientes del latín, combinadas con estructuras muy 
            útiles de sentencias, para generar texto de Lorem Ipsum que parezca
            razonable. Este Lorem Ipsum generado siempre estará libre de repeticiones,
            humor agregado o palabras no características del lenguaje, etc.</p>
    </body>
</html>
